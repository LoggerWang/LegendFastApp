...
public class GridViewSupport extends GridView {
    ...
    public int getRowHeight() {
        ...
        int childWidthSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(mColumnWidth, MeasureSpec.EXACTLY), 0, p
                .width);
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = GridViewSupport.this.getMeasuredWidth() - GridViewSupport.this.getPaddingLeft() -
